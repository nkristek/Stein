...
namespace Stein.ViewModels.Commands.ApplicationViewModelCommands
{
        ...
        : AsyncViewModelCommand<ApplicationViewModel>
    {
        ...
        public InstallApplicationCommand(IDialogService dialogService, IViewModelService viewModelService, IInstallService installService, IProgressBarService progressBarService)
        {
        ...
        protected override async Task ExecuteAsync(ApplicationViewModel viewModel, object parameter)
        {
            ...
            try
            {
                var installationResult = await ViewModelInstallService.Install(
                    _viewModelService,
                    _installService,
                    _progressBarService,
