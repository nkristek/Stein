...
namespace Stein.ViewModels.Commands.ApplicationViewModelCommands
{
        ...
        : AsyncViewModelCommand<ApplicationViewModel>
    {
        ...
        public UninstallApplicationCommand(IDialogService dialogService, IViewModelService viewModelService, IInstallService installService, INotificationService notificationService, IUriService uriService, string downloadFolderPath)
        {
        ...
        protected override async Task ExecuteAsync(ApplicationViewModel viewModel, object parameter)
        {
            ...
            try
            {
                mainWindowDialogModel.RecentInstallationResult = await ViewModelInstallService.Uninstall(
                    _viewModelService,
                    _installService,
