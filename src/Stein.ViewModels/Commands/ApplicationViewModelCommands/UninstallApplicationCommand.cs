...
namespace Stein.ViewModels.Commands.ApplicationViewModelCommands
{
        ...
        : AsyncViewModelCommand<ApplicationViewModel>
    {
        ...
        public UninstallApplicationCommand(IDialogService dialogService, IViewModelService viewModelService, IInstallService installService, string downloadFolderPath)
        {
